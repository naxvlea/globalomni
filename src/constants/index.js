...
const testimonials = [
  {
    ...
    imgSrc: "https://storage.googleapis.com/a1aa/image/vlXEXj8046Y2ORlsevlf0ODDAvJQGijFUeIKARmDgxM3LcvnA.jpg",
  },
  {
    ...
    imgSrc: "https://storage.googleapis.com/a1aa/image/dIGerO7SZfqRV0z7w67rDI6fBZd4ofLSdK3dizNHXj24W4eeE.jpg",
  },
  {
    ...
    imgSrc: "https://storage.googleapis.com/a1aa/image/LQeeRdGWezRPvJrXCxARd2rfFFvbQRHOSmiFAieKwSNquw9eE.jpg",
  },
  {
  ...
  
  {
    ...
    imgSrc: "https://storage.googleapis.com/a1aa/image/0eBw1jknrxwBcqKol6ArtW2FpOd9JKGcegexVuBYfISBX4eeE.jpg",
  },
  {
    text: "This is another testimonial text. It provides feedback about the service.",
    name: "Emily Davis",
...
const projects = [
  {
    name: "Sunset Road",
    description:
      "Media Size : 1800px(W) x 600px(H) | Operational Hours : 17 Hours (7AM - 12AM) |  Quantity: ",
    videoSrc: videoSrc1, 
    image: carrent,
  },
  {
  ...
  },
  {
    ...
    description:
      "Media Size : 2160px (W) x 1200px (H) | Operational Hours : 17 Hours (7 AM - 12 AM) | Quantity: ",
    videoSrc: videoSrc3,
    image: tripguide,
  },
  {
    name: "Mall Bali Galeria Side B" ,
     description:
     "Media Size : 17m (W) x 10m (H) | 2160px (W) x 1200px (H) | Operational Hours : 17 Hours (7 AM - 12 AM)",
